          ...
          >
            ...
            <ScrollView style={{ padding: 28 }} showsVerticalScrollIndicator={false}>
              <Text style={{ color: colors.ink, fontSize: 14, lineHeight: 22, marginBottom: 16 }}>
                Dream Sports International informa a todos los deportistas, padres de familia, entrenadores, clubes aliados y entidades colaboradoras que, luego de analizar las diferentes solicitudes recibidas y de realizar una evaluación preventiva de las condiciones logísticas y de movilidad, hemos tomado la decisión de <Text style={{ fontWeight: "700" }}>aplazar el inicio del Internacional 2026.</Text>
              </Text>
              <Text style={{ color: colors.ink, fontSize: 14, lineHeight: 22, marginBottom: 16 }}>
              ...
              <View style={{ backgroundColor: colors.surfaceElevated, borderLeftWidth: 4, borderLeftColor: colors.gold, borderRadius: 10, padding: 20, marginBottom: 20 }}>
                <Text style={{ color: colors.gold, fontSize: 11, fontWeight: "800", letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 12 }}>
                  NUEVAS FECHAS — INTERNACIONAL 2026
                </Text>
              ...
              <Text style={{ color: colors.ink, fontSize: 14, lineHeight: 22, marginBottom: 16 }}>
                Agradecemos profundamente la comprensión, confianza y respaldo de todos quienes hacen parte de este proyecto. Estamos convencidos de que esta decisión responsable permitirá desarrollar el programa en las mejores condiciones posibles.
              </Text>
              <Text style={{ color: colors.inkMuted, fontSize: 13, lineHeight: 20, marginBottom: 8 }}>
                Reiteramos nuestro compromiso con la formación deportiva, el desarrollo integral de los jóvenes y la creación de oportunidades internacionales para los talentos.
              </Text>
