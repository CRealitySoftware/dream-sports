...
const DISCIPLINE_IMAGES: Record<Discipline, any> = {
  ...
  cycling: require("../../../assets/images/sports/cycling.jpg"),
}
  ...
  return (
    ...
    >
      <Image
        ...
        source={DISCIPLINE_IMAGES[discipline]}
    ...
    >
      ...
      >
        ...
        <View className="hidden md:flex flex-row px-6" style={{ gap: 16 }}>
          {DISCIPLINES.map((d) => (
            <DisciplineCard key={d} discipline={d} colors={colors} t={t} />
          ))}
        </View>
        ...
        >
          {DISCIPLINES.map((d) => (
            <DisciplineCard key={d} discipline={d} colors={colors} t={t} fixedWidth={280} />
          ))}
        </ScrollView>
      </View>
    </View>
