const es = {
  ...
  aboutMissionVision: {
    ...
    visionLabel: "Visión",
    visionBody: "Ser reconocidos en 2029 como la plataforma de referencia en la conexión entre el talento deportivo latinoamericano y el ecosistema profesional europeo, consolidando un modelo escalable, sostenible y de impacto comprobado que haya transformado la vida de más de 300 deportistas jóvenes.",
  },
  exchangeOverview: {
    eyebrow: "El programa",
